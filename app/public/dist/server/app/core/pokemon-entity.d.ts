...
import { Effect as EffectClass } from "./effects/effect";
...
export declare class PokemonEntity extends Schema implements IPokemonEntity {
    ...
    transferAbility(name: Ability | string, positionX?: number, positionY?: number, targetX?: number, targetY?: number): void;
