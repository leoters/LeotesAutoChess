...
function GameOptionsModal(props) {
    ...
    return ((0, jsx_runtime_1.jsx)(modal_1.Modal, { show: props.show, onClose: props.hideModal, header: t("options"), className: "game-options-modal anchor-top", children: (0, jsx_runtime_1.jsxs)(react_tabs_1.Tabs, { children: [(0, jsx_runtime_1.jsxs)(react_tabs_1.TabList, { children: [(0, jsx_runtime_1.jsx)(react_tabs_1.Tab, { children: t("sound") }, "sound"), (0, jsx_runtime_1.jsx)(react_tabs_1.Tab, { children: t("interface") }, "interface"), (0, jsx_runtime_1.jsx)(react_tabs_1.Tab, { children: t("hotkeys") }, "hotkeys"), (0, jsx_runtime_1.jsx)(react_tabs_1.Tab, { children: t("game_files") }, "files")] }), (0, jsx_runtime_1.jsxs)(react_tabs_1.TabPanel, { children: [(0, jsx_runtime_1.jsxs)("label", { style: { width: "100%" }, children: [t("music_volume"), ": ", preferences.musicVolume, " %", (0, jsx_runtime_1.jsx)("input", { type: "range", min: "0", max: "100", value: preferences.musicVolume, onInput: (e) => setPreferences({
                                ...
                                }, label: t("disable_animated_tilemap") }) }), (0, jsx_runtime_1.jsx)("p", { children: (0, jsx_runtime_1.jsx)(checkbox_1.Checkbox, { isDark: true, checked: preferences.disableCameraShake, onToggle: (checked) => {
                                    setPreferences({ disableCameraShake: checked });
                                }, label: t("disable_camera_shake") }) }), (0, jsx_runtime_1.jsx)("p", { children: (0, jsx_runtime_1.jsx)(checkbox_1.Checkbox, { isDark: true, checked: preferences.antialiasing, onToggle: (checked) => setPreferences({ antialiasing: checked }), label: t("antialiasing") }) }), props.page === "main_lobby" && ((0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsxs)("label", { children: [t("renderer"), ":\u00A0", (0, jsx_runtime_1.jsx)("select", { className: "is-light", value: preferences.renderer, onChange: (e) => {
