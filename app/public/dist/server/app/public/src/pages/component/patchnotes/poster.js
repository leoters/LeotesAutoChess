...
function Poster(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "poster", onClick: (e) => e.currentTarget.classList.toggle("flipped"), children: [(0, jsx_runtime_1.jsx)("div", { className: "front", children: (0, jsx_runtime_1.jsx)("img", { src: `/assets/posters/${props.version}.png`, alt: props.version, loading: "lazy" }) }), (0, jsx_runtime_1.jsx)("div", { className: "back", children: patchContent ? ((0, jsx_runtime_1.jsx)("div", { dangerouslySetInnerHTML: { __html: patchContent } })) : ((0, jsx_runtime_1.jsx)("p", { children: t("loading") })) })] }));
}
