...
function GadgetsTab() {
    ...
    return user ? ((0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("p", { style: { textAlign: "right" }, children: t("gadgets_unlocked", { count: nbGadgetsUnlocked, total: gadgets.length }) }), (0, jsx_runtime_1.jsx)("ul", { className: "gadgets", children: gadgets.map((g) => ((0, jsx_runtime_1.jsxs)("li", { className: (0, jsx_1.cc)("gadget", "my-container", {
