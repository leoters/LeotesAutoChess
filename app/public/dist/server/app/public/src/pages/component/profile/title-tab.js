...
function TitleTab() {
    ...
    return user && titles ? ((0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsxs)("div", { style: { display: "flex", justifyContent: "space-between" }, children: [(0, jsx_runtime_1.jsx)(checkbox_1.Checkbox, { checked: showUnlocked, onToggle: setShowUnlocked, label: t("toggle_locked"), isDark: true }), (0, jsx_runtime_1.jsx)("p", { children: t("titles_unlocked", { count: user.titles.length, total: Object.keys(types_1.Title).length }) })] }), (0, jsx_runtime_1.jsxs)("ul", { className: "titles", children: [(0, jsx_runtime_1.jsx)("li", { className: (0, jsx_1.cc)("clickable", "my-box", {
                            unlocked: true,
                            selected: user.title === "",
