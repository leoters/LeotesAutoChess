...
function GameStore() {
    ...
    return ((0, jsx_runtime_1.jsx)("ul", { className: "game-pokemons-store", children: shop.map((pokemon, index) => {
            ...
            if (pokemon != Pokemon_1.Pkm.DEFAULT) {
                return ((0, jsx_runtime_1.jsx)(game_pokemon_portrait_1.default, { origin: "shop", index: index, pokemon: pokemon, inPlanner: (_a = teamPlanner === null || teamPlanner === void 0 ? void 0 : teamPlanner.some(p => Pokemon_1.PkmFamily[p.name] === Pokemon_1.PkmFamily[pokemon])) !== null && _a !== void 0 ? _a : false, onMouseEnter: () => {
                        if (scene) {
