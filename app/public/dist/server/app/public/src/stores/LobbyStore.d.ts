...
export declare const lobbySlice: import("@reduxjs/toolkit").Slice<IUserLobbyState, {
    ...
    changePokemonCollectionItem: (state: import("immer").WritableDraft<IUserLobbyState>, action: PayloadAction<{
        id: string;
        field: string;
        value: any;
    }>) => void;
    ...
    setBoosterContent: (state: import("immer").WritableDraft<IUserLobbyState>, action: PayloadAction<Booster>) => void;
...
export declare const removeMessage: import("@reduxjs/toolkit").ActionCreatorWithPayload<Message, "lobby/removeMessage">, setBoosterContent: import("@reduxjs/toolkit").ActionCreatorWithPayload<Booster, "lobby/setBoosterContent">, changePokemonCollectionItem: import("@reduxjs/toolkit").ActionCreatorWithPayload<{
    id: string;
    field: string;
    value: any;
}, "lobby/changePokemonCollectionItem">, pushMessage: import("@reduxjs/toolkit").ActionCreatorWithPayload<Message, "lobby/pushMessage">, setLeaderboard: import("@reduxjs/toolkit").ActionCreatorWithPayload<ILeaderboardInfo[], "lobby/setLeaderboard">, setBotLeaderboard: import("@reduxjs/toolkit").ActionCreatorWithPayload<ILeaderboardBotInfo[], "lobby/setBotLeaderboard">, setLevelLeaderboard: import("@reduxjs/toolkit").ActionCreatorWithPayload<ILeaderboardInfo[], "lobby/setLevelLeaderboard">, setTabIndex: import("@reduxjs/toolkit").ActionCreatorWithPayload<number, "lobby/setTabIndex">, addRoom: import("@reduxjs/toolkit").ActionCreatorWithPayload<RoomAvailable<any>, "lobby/addRoom">, removeRoom: import("@reduxjs/toolkit").ActionCreatorWithPayload<string, "lobby/removeRoom">, setCcu: import("@reduxjs/toolkit").ActionCreatorWithPayload<number, "lobby/setCcu">, setSearchedUser: import("@reduxjs/toolkit").ActionCreatorWithOptionalPayload<IUserMetadata | undefined, "lobby/setSearchedUser">, resetLobby: import("@reduxjs/toolkit").ActionCreatorWithoutPayload<"lobby/resetLobby">, setSuggestions: import("@reduxjs/toolkit").ActionCreatorWithPayload<ISuggestionUser[], "lobby/setSuggestions">, addTournament: import("@reduxjs/toolkit").ActionCreatorWithPayload<TournamentSchema, "lobby/addTournament">, removeTournament: import("@reduxjs/toolkit").ActionCreatorWithPayload<TournamentSchema, "lobby/removeTournament">, changeTournament: import("@reduxjs/toolkit").ActionCreatorWithPayload<{
    tournamentId: string;
    field: string;
    value: any;
