...
export declare const MAX_LEVEL = 9;
export declare const ALLOWED_GAME_RECONNECTION_TIME: number;
...
export declare const MinStageForGameToCount = 10;
...
export declare const PORTAL_CAROUSEL_BASE_DURATION = 23000;
