...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const data = yield (0, promises_1.readFile)(process.argv[2] || "db-commands/botv2.json", "utf8");
        if (!data) {
            logger_1.logger.error("Couldn't load botv2.json");
            process.exit(1);
        }
...
main();
//# sourceMappingURL=populate-bots-from-local.js.map